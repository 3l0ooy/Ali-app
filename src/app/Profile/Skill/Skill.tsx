...
const Skill = () => {
    ...
    const fetchSkills = async () => {
        ...
        try {
            ...
            const technicalSkills = fetchedSkills.filter((skill: { type: string; }) => 
                ["skill_prog", "skill_algo", "skill_sys-admin", "skill_front-end", 
                "skill_back-end", "skill_stats", "skill_ai", "skill_game", "skill_tcp"].includes(skill.type));
                
            const technologies = fetchedSkills.filter((skill: { type: string; }) => 
                ["skill_go", "skill_js", "skill_html", "skill_css", "skill_unix", 
    ...
    const drawSkillsChart = (technicalSkills, technologies) => {
        const svgTech = document.getElementById('skills-chart-tech');
        const svgTechs = document.getElementById('skills-chart-techs');
        ...
        for (let i = 1; i <= levels; i++) {
            ...
            circle.setAttribute('cy', techCircleY);
        ...
        technicalSkills.forEach((d, i) => {
            ...
            line.setAttribute('y1', techCircleY);
        ...
        for (let i = 1; i <= levels; i++) {
            ...
            const circle = document.createElementNS("http://www.w3.org/2000/svg", "circle");
            circle.setAttribute('cx', centerX);
            circle.setAttribute('cy', techCircleY2);
            circle.setAttribute('r', levelRadius);
            circle.setAttribute('stroke', '#ddd');
            circle.setAttribute('fill', 'none');
        ...
        technologies.forEach((d, i) => {
            ...
            const line = document.createElementNS("http://www.w3.org/2000/svg", "line");
            line.setAttribute('x1', centerX);
            line.setAttribute('y1', techCircleY2);
            line.setAttribute('x2', x);
            line.setAttribute('y2', y);
            line.setAttribute('stroke', '#bbb');
    ...
    return (
        <div className={Style.Skill}>
            ...
            <div className={Style.ChartWrapper}>
                <svg id="skills-chart-tech" className={Style.Chart} width="200" height="200"></svg>
                <svg id="skills-chart-techs" className={Style.Chart1} width="200" height="200"></svg>
            </div>
        </div>
    );
};
